...
editNameInput:{backgroundColor:'rgba(255,255,255,0.6)',borderRadius:10,padding:10,color:'#1a2a3a',fontSize:20,fontWeight:'700',textAlign:'center',borderWidth:1,borderColor:'rgba(255,255,255,0.8)',marginBottom:4,width:'80%'},
displayName:{color:'#1a2a3a',fontSize:22,fontWeight:'700',marginBottom:4},
username:{color:'#556677',fontSize:15},
statsRow:{flexDirection:'row',backgroundColor:'rgba(255,255,255,0.6)',borderRadius:16,padding:16,marginHorizontal:24,marginBottom:16,borderWidth:1,borderColor:'rgba(255,255,255,0.8)'},
...
infoCard:{backgroundColor:'rgba(255,255,255,0.6)',borderRadius:16,padding:16,marginHorizontal:24,borderWidth:1,borderColor:'rgba(255,255,255,0.8)',marginBottom:16},
sectionTitle:{fontSize:16,fontWeight:'700',color:'#1a2a3a',marginBottom:4},
...
editInput:{backgroundColor:'rgba(255,255,255,0.8)',borderRadius:10,padding:12,color:'#1a2a3a',fontSize:15,marginBottom:16,borderWidth:1,borderColor:'rgba(255,255,255,0.9)'},
...
prefItemSelected:{},
prefCheckbox:{width:22,height:22,borderRadius:6,borderWidth:2,borderColor:'#2196F3',marginRight:12,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(255,255,255,0.6)'},
prefCheckboxSelected:{backgroundColor:'#2196F3'},
prefCheckmark:{color:'#ffffff',fontSize:13,fontWeight:'bold'},
prefText:{flex:1,fontSize:14,color:'#556677'},
prefTextSelected:{color:'#1a2a3a',fontWeight:'500'},
cancelButton:{backgroundColor:'rgba(255,255,255,0.5)',borderRadius:12,padding:16,alignItems:'center',marginHorizontal:24,marginBottom:12,borderWidth:1,borderColor:'rgba(0,0,0,0.1)'},
cancelButtonText:{color:'#556677',fontSize:16,fontWeight:'600'},
blockedButton:{backgroundColor:'rgba(255,255,255,0.5)',borderRadius:12,padding:16,alignItems:'center',marginHorizontal:24,marginBottom:12,borderWidth:1,borderColor:'rgba(0,0,0,0.15)'},
blockedButtonText:{color:'#556677',fontSize:16,fontWeight:'600'},
signOutButton:{backgroundColor:'rgba(255,255,255,0.5)',borderRadius:12,padding:16,alignItems:'center',marginHorizontal:24,borderWidth:1,borderColor:'#F15A22'},
